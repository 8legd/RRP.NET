...
Public Class Batch
    ...
    Protected Class requestResponse
        ...
        Sub New(ByVal requestUrl As System.Uri,
                ByVal requestMethod As String,
                ByVal requestContentType As String,
    ...
    Public Sub ReadResponse(ByVal requestIndex As Integer,
                             ByRef responseStatusOK As Boolean,
                             ByRef responseStatusLine As String,
                             ByRef responseHeaders As System.Net.WebHeaderCollection,
